...
class VersionedLayerClientImpl {
 ...
 protected:
  ...
  virtual CallbackResponse<client::OlpClient> LookupApi(
      client::CancellationContext cancellation_context, std::string service,
      std::string serviceVersion, FetchOptions options) const;

  virtual MetadataApi::CatalogVersionResponse GetLatestVersion(
      client::CancellationContext cancellation_context,
      const DataRequest& data_request) const;

  virtual QueryApi::PartitionsResponse GetPartitionById(
      client::CancellationContext cancellation_context,
      const DataRequest& data_request) const;

  virtual BlobApi::DataResponse GetBlobData(
      client::CancellationContext cancellation_context,
      const DataRequest& data_request) const;
